...
export const AppBenefitsList = () =>
{
    return (
        <div>
            ...
            <AppBenefitsItem title="Descuentos y promociones exclusivos" text="Sé el primero en conocer los descuentos y promociones exclusivos disponibles solo a través de AnticipadApp." icon="/assets/emojis/discount.png" />
        </div>
    );
};